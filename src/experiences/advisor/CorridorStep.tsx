...
export function CorridorStep({ selectedCorridors, onToggleCorridor, onBack, onNext }: Props) {
  return (
    <div className={styles.step}>
      <div className={styles.stepHeader}>
        <h1 className={styles.stepTitle}>Which corridors?</h1>
        <p className={styles.stepSubtitle}>
          Select the destination countries. You'll see all three products compared side by side for each.
        </p>
      </div>
        ...
        {CORRIDORS.map((corridor) => {
          ...
          return (
            <button
              ...
              onClick={() => onToggleCorridor(corridor.id)}
      ...
      <div className={styles.footer}>
        ...
        <button
          ...
          onClick={onNext}
          disabled={selectedCorridors.length === 0}
        >
          See recommendations
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
